...
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2571, 204, 532, 2578, 'Realiza una consulta en la base de datos');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2572, 204, 532, 2579, 'Inserta datos en la base de datos');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2573, 204, 532, 2580, 'Actualiza datos por ID');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2574, 204, 532, 2581, 'Actualiza datos por nombre de usuario');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2575, 204, 532, 2582, 'Elimina datos por ID');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2576, 204, 532, 2583, 'Elimina datos por nombre de usuario');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2577, 204, 532, 2584, 'Obtiene todos los datos de una tabla');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2578, 204, 532, 2585, 'Obtiene datos filtrados por condiciones');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2579, 204, 532, 2586, 'Elimina todos los datos de una tabla');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2580, 204, 532, 2587, 'Ejecuta una consulta nombrada predefinida');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2581, 204, 532, 2588, 'Ejecuta una serie de consultas nombradas predefinidas, pasándole los parámetros como valores de las keys ({ namedQuery: [params] })');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2582, 204, 532, 2589, 'Inicia una transacción en la base de datos');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2583, 204, 532, 2590, 'Confirma una transacción en la base de datos');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2584, 204, 532, 2591, 'Revierte una transacción en la base de datos');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2585, 204, 532, 2592, 'Finaliza una transacción en la base de datos');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2586, 204, 532, 2593, 'Ejecuta una serie de consultas dentro de una transacción, pasándole los parámetros como valores de las keys ({ query: [params] })');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2587, 205, 534, 2594, 'Inicializa el sistema de sesiones');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2588, 205, 534, 2595, 'Inicia sesión para un usuario');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2589, 205, 534, 2596, 'Registra un nuevo usuario');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2590, 205, 534, 2597, 'Cambia el perfil activo del usuario');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2591, 205, 534, 2598, 'Inicia el proceso de recuperación de contraseña');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2592, 205, 534, 2599, 'Restablece la contraseña del usuario');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2593, 205, 535, 2600, 'Crea y actualiza la sesión del usuario');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2594, 205, 535, 2601, 'Crea una nueva sesión');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2595, 205, 535, 2602, 'Actualiza los datos de la sesión');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2596, 205, 535, 2603, 'Destruye la sesión actual');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2597, 205, 535, 2604, 'Obtiene los datos de la sesión');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2598, 205, 535, 2605, 'Verifica si existe una sesión activa');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2599, 206, 536, 2606, 'Envía un correo electrónico');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2600, 206, 536, 2607, 'Envía un correo electrónico de recuperación');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2601, 206, 537, 2608, 'Genera un nuevo token');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2602, 206, 537, 2609, 'Verifica un token existente');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2603, 206, 538, 2610, 'Valida un nombre de usuario');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2604, 206, 538, 2611, 'Valida un correo electrónico');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2605, 206, 538, 2612, 'Valida una contraseña');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2606, 206, 538, 2613, 'Valida la confirmación de la contraseña');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2607, 206, 538, 2614, 'Obtiene los valores de validación');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2608, 206, 538, 2615, 'Valida un nombre');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2609, 206, 538, 2616, 'Valida una descripción');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2610, 206, 539, 2617, 'Convierte parámetros de objeto');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2611, 206, 539, 2618, 'Convierte parámetros de array');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2612, 206, 539, 2619, 'Convierte estructura a array ordenado');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2613, 206, 540, 2620, 'Convierte la primera letra a mayúscula');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2614, 206, 540, 2621, 'Obtiene todos los nombres de métodos dinámicos');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2615, 206, 540, 2622, 'Maneja errores personalizados');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2616, 204, 532, 2623, 'security.dbms.updatebyid');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2617, 204, 532, 2624, 'security.dbms.deletebyid');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2618, 204, 532, 2625, 'security.dbms.executenamedquery');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2619, 205, 534, 2626, 'session.session.changeactiveprofile');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2620, 204, 532, 2627, 'Parsear los menus, opciones y perfiles a un formato iterable para el front');
INSERT INTO public.transaction (tx, id_subsystem, id_class, id_method, description) VALUES (2621, 206, 541, 2628, NULL);
